...
urlpatterns = [
    ...
    path("api/backup/export", BackupExportView.as_view()),
    path("api/backup/import/", BackupImportView.as_view(), name="backup-import-direct"),
    path("api/backup/import", BackupImportView.as_view()),
    path("api/auth/backup/export/", BackupExportView.as_view()),
    path("api/auth/backup/export", BackupExportView.as_view()),
    path("api/auth/backup/import/", BackupImportView.as_view()),
    path("api/auth/backup/import", BackupImportView.as_view()),
