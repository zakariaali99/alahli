...
class PackageRepository {
  ...
  Future<List<PackageModel>> fetchPackages() async {
    try {
      ...
      throw dioToAppApiException(e, fallback: 'فشل تحميل الباقات');
    }
  }
  Future<PackageModel> createPackage(Map<String, dynamic> data) async {
    try {
      ...
      if (resData == null) throw AppApiException(message: 'فشل إنشاء الباقة');
      return PackageModel.fromJson(resData);
    } on DioException catch (e) {
      throw dioToAppApiException(e, fallback: 'فشل إنشاء الباقة');
    }
  }
  ...
  Future<PackageModel> updatePackage(int id, Map<String, dynamic> data) async {
    try {
      ...
      final resData = asMap(res.data);
      if (resData == null) throw AppApiException(message: 'فشل تعديل الباقة');
      return PackageModel.fromJson(resData);
    } on DioException catch (e) {
      throw dioToAppApiException(e, fallback: 'فشل تعديل الباقة');
    }
  }
  ...
  Future<void> deletePackage(int id) async {
    try {
      ...
      throw dioToAppApiException(e, fallback: 'فشل حذف الباقة');
    }
  }
}
